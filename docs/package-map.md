...
| `internal/model` | Pure data types: `Server`, `GatewayRoute`, `Cluster`, `Alias`, `Tunnel`, `ConnectOptions` |
| `internal/db` | SQLite repositories — `ServerRepo`, `GatewayRepo`, `AliasRepo`, `ClusterRepo`, `ThemeRepo`, `TunnelRepo` |
